...
* The session id *7e8383a4-082c-4ffe-a4bc-c40fd3363c5e* has an alias of *0*.
...
For example, if the URL is http://localhost:8080/ this alias would be used.
* The session id *1d526d4a-c462-45a4-93d9-84a39b6d44ad* has an alias of *1*.
